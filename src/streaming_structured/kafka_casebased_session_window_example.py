...
from pyspark.sql.functions import split, from_json, explode, window, col, session_window
...
#
session_window = session_window(messagesWithRecord.timestamp, \
    F.when(messagesWithRecord.entityType == "Audience", "5 seconds") \
    .when(messagesWithRecord.entityType == "Person", "30 seconds").otherwise("5 minutes"))

  
#
# ADDED SESSION WINDOW
#
windowedCounts = messagesWithRecord \
